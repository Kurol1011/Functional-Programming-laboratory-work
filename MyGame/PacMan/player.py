...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y,filename):
        ...
        img = pygame.image.load("assets/images/walk.png").convert()
        ...
        img = pygame.image.load("assets/images/explosion.png").convert()
    ...
    def update(self,horizontal_blocks,vertical_blocks):
        #print(f'X:{self.rect.x} and Y:{self.rect.y}') 386 448
        if self.rect.x == 386 and self.rect.y == 448:
            print('flag true')
            self.flag = True
